% Example of ARP corresponding to a tetragonal lattice (example 2.1)
...
for n1=-2:1:2
    for n2=-2:1:2
        ...
        L3 = A*([n1;n2]+[1/2;0]);
        L4 = A*([n1;n2]+[0;0]);
        plot(L1(1)/la,L1(2)/la,'ro','MarkerSize',6,'MarkerFaceColor','r');
        plot(L2(1)/la,L2(2)/la,'ro','MarkerSize',6,'MarkerFaceColor','r');
        plot(L3(1)/la,L3(2)/la,'ro','MarkerSize',6,'MarkerFaceColor','r');
        plot(L4(1)/la,L4(2)/la,'ro','MarkerSize',6,'MarkerFaceColor','r');
    end
end
start = [1/2,1/2];
